        ...
        <div className="h-full flex flex-col font-sans">
            <header className="mb-8 flex justify-between items-end">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-[28px] font-black tracking-tight text-slate-900 mb-1">КАПТЫ</h1>
                        <p className="text-slate-500 text-[13px] font-medium tracking-wide">Списки Каптов.</p>
                    </div>
                </div>
            </header>
