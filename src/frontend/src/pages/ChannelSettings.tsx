...
import { Hash, Save, AlertCircle, Loader2, Ticket, Calendar, Moon, Activity } from 'lucide-react';
            ...
            <tbody>
              ...
              <tr className="border-b border-slate-100 hover:bg-slate-50/50 transition-colors">
                <td className="py-4 px-6 flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-[13px] text-slate-800">Мероприятия</div>
